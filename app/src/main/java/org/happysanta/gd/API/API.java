...
public class API {
	...
	public static Request getLevels(int offset, int limit, LevelsSortType sort, ResponseHandler handler)
		...
		params.add(new Pair<String, String>("sort", sort.toString()));
		params.add(new Pair<String, String>("offset", String.valueOf(offset)));
		params.add(new Pair<String, String>("limit", String.valueOf(limit)));
	...
	public static Request getNotifications(boolean installedFromAPK, ResponseHandler handler) {
		List<Pair<String, String>> params = new LinkedList<Pair<String, String>>();
		params.add(new Pair<String, String>("apk", String.valueOf(installedFromAPK ? 1 : 0)));
	...
	public static Request sendStats(String statsJSON, String installationID, int useCheats, ResponseHandler handler) {
		List<Pair<String, String>> params = new LinkedList<Pair<String, String>>();
		params.add(new Pair<String, String>("stats", statsJSON));
		params.add(new Pair<String, String>("id", installationID));
		params.add(new Pair<String, String>("use_cheats", String.valueOf(useCheats)));
